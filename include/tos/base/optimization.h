#ifndef TOS_BASE_OPTIMIZATION_H_
#define TOS_BASE_OPTIMIZATION_H_
...
// aligned on a cacheline boundary with `TOS_CACHELINE_ALIGNED`
...
// TOS_CACHELINE_ALIGNED
//
// Indicates that the declared object be cache aligned using
// `TOS_CACHELINE_SIZE` (see above). Cacheline aligning objects allows you
...
// for more information.
//
// On some compilers, `TOS_CACHELINE_ALIGNED` expands to an `__attribute__`
...
// For example,
//
//   TOS_CACHELINE_ALIGNED static Foo* foo = ...
//
//   class TOS_CACHELINE_ALIGNED Bar { ...
//
// Recommendations:
//
...
// TOS_PREDICT_TRUE, TOS_PREDICT_FALSE
//
...
// Example:
//
//   if (TOS_PREDICT_TRUE(expression)) {
...
#endif  // TOS_BASE_OPTIMIZATION_H_
